        ...
        return (
          <TouchableWithoutFeedback style={styles.stepLabelItem} key={index} onPress={() => this.stepPressed(index)}>
            <View style={styles.stepLabelItem}>
              <Text style={[styles.stepLabel,selectedStepLabelStyle , { fontSize: this.state.customStyles.labelSize, textAlign: this.state.customStyles.labelTextAlign, textAlignVertical: this.state.customStyles.labelTextAlignVertical }, direction==='vertical'?{ minHeight: this.state.customStyles.labelHeight } : { minWidth: this.state.customStyles.labelHeight } ]}>
                {label}
              </Text>
            </View>
          </TouchableWithoutFeedback>
